...
robots-server: robots-server.o server-parser.o server-tcp-handler.o error-handler.o
	$(CC) $(CFLAGS) -o robots-server robots-server.o error-handler.o server-parser.o server-tcp-handler.o -lboost_program_options

 
robots-server.o: robots-server.cpp server-parser.h server-tcp-handler.h error-handler.h
