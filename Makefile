...
robots-server: robots-server.o game-engine.o byte-parser.o event.o server-parser.o server-tcp-handler.o error-handler.o
	$(CC) $(CFLAGS) -o robots-server robots-server.o game-engine.o server-tcp-handler.o byte-parser.o event.o server-parser.o error-handler.o -lboost_program_options

 
robots-server.o: robots-server.cpp game-engine.h
	$(CC) $(CFLAGS) -c robots-server.cpp -lboost_program_options

game-engine.o: game-engine.cpp game-engine.h server-parser.h event.h byte-parser.h server-tcp-handler.h error-handler.h
